...
\begin{frame}{用Beamer很高大上？}
    \begin{itemize}[<+-| alert@+>] % 当然，除了alert，手动在里面插 \pause 也行
        ...
        \item Overleaf项目地址位于 \url{https://www.overleaf.com/latex/templates/suda-beamer-theme/zrrdkvxkktjr}，可以直接使用
        \item GitHub项目地址位于 \url{https://github.com/ymliucs/SUDA-Beamer-Theme}
    \end{itemize}
\end{frame}
...
\begin{frame}{这一份主题与 THU Beamer Theme 的区别在于}
    \begin{itemize}
        \item 修改了校徽
        \item 从校徽上进行颜色提取并修改了配色（RGB\#AF251C）
        \item 所有中文字体全部使用华文楷体，英文字体使用 Times New Roman
        \item 数学公式和 article 的风格一致（使用衬线字体）
        \item 删除 ctex 包，只使用 XeCJK      
        \item 修改了 itemize 每层的图标
        \item 修改了图表的 caption，使用中文
        \item 修改脚注，每张slide重新计数
        \item \textbf{注意：华文楷体和itemize符号使用的wingding字体为微软版权所有，严禁商用，在C:\textbackslash Windows\textbackslash Fonts目录下同样可以找到这两个字体}
    \end{itemize}
\end{frame}
